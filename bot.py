...
def welcome():
    ...
    print(f"{Fore.CYAN + Style.BRIGHT}██║  ██║███████║   ██║   ██║ ╚████║╚██████╔ ")
    print(f"{Fore.CYAN + Style.BRIGHT}╚═╝  ╚═╝╚══════╝   ╚═╝   ╚═╝  ╚═══╝ ╚═════╝ ")
    print(f"{Fore.GREEN + Style.BRIGHT}               JOIN AIRDROP         ")
    print(f"{Fore.YELLOW + Style.BRIGHT}      https://t.me/AirdropSyncReborn ")
    print(Style.RESET_ALL)  # Mengembalikan warna terminal ke default
